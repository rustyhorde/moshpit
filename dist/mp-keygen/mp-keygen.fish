...
complete -c mp-keygen -n "__fish_mp_keygen_needs_command" -f -a "generate" -d 'Generate a new ed25519 public/private key pair'
...
complete -c mp-keygen -n "__fish_mp_keygen_using_subcommand help; and not __fish_seen_subcommand_from generate verify fingerprint help" -f -a "generate" -d 'Generate a new ed25519 public/private key pair'
