...
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "start" -d 'Start the agent daemon'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "add-key" -d 'Add an identity key to the agent'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "list" -d 'List identities held by the agent'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "remove-key" -d 'Remove an identity from the agent'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "lock" -d 'Lock the agent (clear keys from memory)'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "unlock" -d 'Unlock the agent (reload keys from vault)'
complete -c mpa -n "__fish_mpa_using_subcommand help; and not __fish_seen_subcommand_from start add-key list remove-key lock unlock help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
